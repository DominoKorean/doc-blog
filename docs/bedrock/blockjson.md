...
텍스쳐는 파일 이름 뒤에 .png만 때주면 됨  
다만 커스텀 텍스쳐는 안돼고 이미 있는 텍스쳐의 한에서만 가능
...
화분에 꽂았을때 텍스쳐를 넣어둠  
이런거는 [샘플팩](https://github.com/Mojang/bedrock-samples)에서 하나하나 확인하는 수 밖에 없음
