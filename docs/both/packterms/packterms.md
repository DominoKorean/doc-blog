...
아이리스 셰이더의 폿지 포크인 Oculus 및 마인크래프트 1.7.10 버전용 포크인 Angelica도 있다.  
...
커스폿지 자체가 마인크래프트뿐만 아니라 다양한 게임을 지원하는 모드 플랫폼이기 때문에 스타듀벨리, 인조이등의 다른 게임의 모드를 같이 관리할 수 있다는 장점 또한 존재한다.  
